...
public class ChatTestMainActivity extends Activity {

    public static String liantong = "kjPh/XMody/pY2FKQ+4639Gdf9jgwcAheVqICz1bJ3Zcdli+7cTnWxOR5oGC0O56ecXgZa+5QrTyRUAM4qr3VA==";
    String yidong = "8X5LimyYEqBoxkZN0KQ+0Kqp4iwFglHKtCJmRfRyynyMnn35ydLgs7yZoHfVJGRrMwBhXjX/pWmdnk8MERLBLQ==";
    ...
    public void connect(View view) {
        RongIM.connect(liantong, new RongIMClient.ConnectCallback() {
            ...
            public void onSuccess(String s) {
                Log.e("", "连接成功—————>" + s);
                Toast.makeText(ChatTestMainActivity.this, "连接成功" + s, Toast.LENGTH_SHORT).show();
            }
